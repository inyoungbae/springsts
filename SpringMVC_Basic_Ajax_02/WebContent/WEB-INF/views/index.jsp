...
<script type="text/javascript">
	...
	*/
	...
	/*
	 ...
	 _data = JSON.stringify(_param); //jsonString으로 변환 JSON.stringify : 객체를 제이슨형태의 스트링으로 바꿔줌 
   	 alert(_data);
   	...
   	$.ajax({
   			  ...
   			  url : "response2.kosta",
   			  cache: false,
   			  dataType: "json",   //서버가 클라이언트한테 응답하는 형식 
   			  data:_data,          //클라이어트가 서버에게 보내는 데이터 
   			  processData: false,
   			  contentType: "application/json; charset=utf-8",   //보낼떄 쓰는것들 
