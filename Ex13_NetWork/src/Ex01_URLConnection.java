...
//URLConnection 클래스(연결된 URL 주소로 부터 다양한 정보와 작업)  -연결은 url 작업은 connection이 
//http://image3.kangcom.com/2018/02/b_pic/201802028179.jpg
public class Ex01_URLConnection {
	public static void main(String[] args) throws IOException {
		//http://www.kangcom.com/images/banner/amazon_Best.jpg 살아있는 주소의 이미지를 내 피시로 가져오는 작업을 하기 위함 
		...
		FileOutputStream fos = new FileOutputStream("copy2.jpg"); //파일 생성 (프로젝트 폴더)   //FileOutputStream파일이없으면 만들어요.
