...
public class AjaxController {
	...
	//1. JsonView도 필요없고 그냥 순수하게 text로 만든것  - framwork사용 X / 객체 1개짜리할때는 좋음 
	...
	@RequestMapping(value="objMapper.ajax") //2. 객체를 넣으면 JSON형태의 문자열로 바꿔줌..다시 파싱해야돼요
	...
	@RequestMapping(value="responseBody.ajax")  //3. RESPONSEBODY(전제조건:잭슨3총사(pom.xml의 dependency로)/mvc네임스페이스 + 스키마 추가)
