...
<script type="text/javascript">
	...
	const swalQueueStep = Swal.mixin({
	 ...
	 function connect() { // 웹소켓 연결 
		wsocket = new WebSocket("ws://192.168.6.27:8090/WebSocket_4Team/Chat-ws.do?cmd=on");  // on : 실시간채팅 페이지로 들어옴 
	...
	function setChatRooms(data){ //data 서버에서 받은 json데이터 
		console.log("데이터 " +data);
		let num = 1;
		$('#dataTable > tbody').empty();  //원래 있던건 비우고 
